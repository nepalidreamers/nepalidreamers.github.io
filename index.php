  ...
  <?php include "layouts/navbar.php"; ?>  
      ...
      <div class="container-fluid">
        <div class="slider-text d-md-flex align-items-center" data-scrollax-parent="true">
          <div class="one-forth ftco-animate align-self-md-center" data-scrollax=" properties: { translateY: '70%' }">
          	<p class="mb-md-5 mb-sm-3" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">A college counseling and success program creating a community of changemakers to empower the millions of young Nepali dreams.</p>
            <p data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><a href="#" class="btn btn-primary px-4 py-3">Learn More</a></p>
          </div>
    ...
    <section class="ftco-section ftco-section-2">
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-8">
    				<h3 class="heading-white">Building Communities for Our Dreamers</h3>
    			</div>
    		</div>
    	</div>
    </section>
    ...
    <section class="ftco-section ftco-services">
      ...
      <div class="container-wrap mt-5">
      	<div class="row d-flex no-gutters">
      		<div class="col-md-6 img ftco-animate" style="background-image: url(images/image-1.jpg);">
      		</div>
      		<div class="col-md-6 d-flex">
      			<div class="services-wrap">
      				<div class="heading-section mb-5 ftco-animate">
		            <h2 class="mb-2">Nepali Dreamers Scholars Program</h2>
		            <span class="subheading">Search Engine &amp; Social Media Optimization Experts</span>
              </div>
              <div class="list-services d-flex ftco-animate">
      				...
      				<div class="list-services d-flex ftco-animate">
      					...
      					<div class="text">
	      					<h3>Self Reflection Workshops</h3>
	      					<p>
              ...
              <div class="list-services d-flex ftco-animate">
      					...
      					<div class="text">
	      					<h3>SAT Prep Classes</h3>
	      					<p>
                    Standardized test preparation classes and proctored test for 10 weeks.
                  </p>
      					</div>
      				</div>
      			</div>
